 ...
 * Config: maxRetries from configuration, initial wait 1s, max 64s.
...
public class RetryPolicy {
     ...
     */
    public <T> T execute(Callable<T> action) throws OpenLException {
        int attempt = 0;
        while (true) {
            try {
                return action.call();
                ...
                throw new OpenLException("Unexpected error during API call", e);
            }
        }
    }
